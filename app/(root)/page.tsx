 ...
 *
 * TradingViewWidget props (used below):
 ...
 * @param {number} [height] - Height of the widget container in pixels.
 * @param {string} [className] - Additional CSS classes for the widget container.
 *
 * @returns {JSX.Element} The home page layout containing TradingView widgets.
 */
const Home = () => {
